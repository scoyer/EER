...
def masked_cross_entropy(logits, target, length, is_logit=True):
    """
    Args:
    ...
    if is_logit:
        ...
        #print("before log:", logits_flat.max())
        log_probs_flat = torch.log(logits_flat + 1e-10)
        #print("after log:", log_probs_flat)
